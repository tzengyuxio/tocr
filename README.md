...
| | 數量 | 備註 |
|---|---|---|
| 雜誌 | 56 本、68 個刊名 | 改過名的刊一個時期一列 |
| 單期 | 2,759 期 | 其中 1,376 期有封面（49.9%） |
| 文章 | 13,321 篇，分佈在 324 期 | 佔全部單期的一成二，其餘只有書目資料 |
| 遊戲 | 6,491 款 | 10,673 條「文章↔遊戲」關聯 |
| 標籤 | 1,062 個 | |
...
目前 55 期 2094 列，涵蓋 2008 與 2010–2013 兩段，全部人工讀圖轉錄。

**目錄頁標的頁碼不代表封底裡沒有索引。** 目錄頁右下角會標「Game Index 封底裡」或
「Game Index P.NNN」，但 VOL.335（標 P.120）與 VOL.336（標 P.118）的封底裡**照樣印著
整份索引**，這兩期就是從封底裡轉錄的。所以要判斷有沒有索引，看封底裡那張圖，
不要從目錄頁的標示推。

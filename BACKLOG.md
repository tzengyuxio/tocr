...
- [ ] **nostalibrary 還有約 100 張封面可以補上站** — 2026-08-26 盤點過了，**先不補**；**2026-09-09 回頭看要不要動**（2026-08-26）。
...
- [ ] **其餘改名刊的沿革資料** — 刊名時期功能已上線（電玩通 PlayStation 系是第一條），還有三條刊系待建：**電腦遊戲世界**（158 期都在，後台建 2 筆即可：第 85 期起本名、第 163 期起「遊戲世界」）、**電擊王**（22 期都在，改名後的 10 期（slug `dg-*`）起算「DengekiGAMES」時期，切點看資料）；**電視遊樂雜誌**（電視遊樂快訊→電視遊樂雜誌→GAME fans，三段）與**電視遊樂報導**（→Super Gamer）**期數已於 2026-08-25 匯入，起始期選得出來了**——雜誌的切點：試刊號與創刊號印《電視遊樂快訊》、No.2 起改《電視遊樂雜誌》、`新刊1號` 起《GAMEfans》；報導的切點：`sg-40`（SuperGamer No.40）是站上最早的改名後期數，真正的切點在總號 306 之前，還要查。時期刊頭圖另找（2026-08-22）。
...
- [ ] **加入《電玩双週刊》資料** — 匯入《電玩宅速配》的前身《電玩双週刊》（2026-08-18）。
...
- [ ] **《攻略月刊》（電腦玩家雜誌社）待建，缺實體本** — 站上沒有、也不在藏家清單裡的一本，
  刊名與 slug 已推導完畢，等封面確認再建（2026-08-25）。
  ...
  **待查**：封面主標印的是「攻略月刊」還是「電腦玩家 攻略月刊」（電腦玩家作品牌小字，
  形狀類似《電玩向前走》封面的「電玩」）；創刊與停刊時間；總期數。維基百科不可當來源，
  這本目前沒有任何可引用的出處。同批未建的還有《光碟世界》（電腦玩家的另一本月刊型刊物）
  與《網路遊戲雙週》（電腦家庭，見國圖 `journalId=69101036`）。

- [ ] **《遊戲天堂》／《Game天堂EX》待建，缺實體本** — 藏家清單有、站上沒有的一組刊系，
  等實體本再建（2026-08-23）。
...
- [ ] **《電擊Dreamcast》要建成獨立刊還是《電擊SEGA SATURN》的後續刊名時期** — 2026-08-23 曾建過一筆獨立的 `dengeki-dc-tw`，同日撤除，等實體本再定（2026-08-23）。
...
- [ ] **華泰任天堂秘笈：24 期都沒有出版日期** — 24 期已於 2026-08-25 匯入（`publishDate` 2026-08-22 起可空，所以日期整批留空），剩下的是**把日期補起來**。原本的阻塞理由是「`publishDate` 必填所以進不來」，那一半已經不成立（2026-08-18 盤點，2026-08-25 更新）。

...
- 預覽（尚未上市作品的搶先介紹，如「先睹為快」「遊戲情報網」「每月新Game」）
- 評測（已上市作品的評分與評論，如「遊戲評析」「新片評鑑」「比較評論」）
- 攻略（遊戲攻略、密技、過關法）
- 新聞（業界消息、新作發表）
- 訪談（製作人或業界人士專訪）
- 硬體（主機、周邊設備介紹）
...
**預覽與評測的差別在於作品是否已上市**：上市前的搶先介紹一律歸「預覽」，已上市作品的評分與評論歸「評測」。各家雜誌的欄目名稱不同（先睹為快、新片評鑑⋯⋯），請依性質判斷而非照抄欄目名。

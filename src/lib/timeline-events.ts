...
const EXTERNAL: ExternalEventInput[] = [
  ...
  {
    at: "1986-07-15",
    // 紅白機 1983 年發售，早於這張圖的起點，圖上因此標的是它滿三年的那天——
    // 這批雜誌創刊時，紅白機已經是既成事實，而不是新機。台灣上市日查不到，
    // 見本檔開頭「四個查不到的日期」。
    title: "紅白機發售滿三年",
    note: "1983-07-15 日本發售，早於本圖起點。台灣無正式上市日。",
    source: "維基百科「ファミリーコンピュータ」（1983-07-15 發售）",
  },
  {
    at: "1987-04-02",
    title: "PC DOS 3.3 發表",
    note: "隨 IBM PS/2 一同發表；3.5 吋 1.44MB 磁片自此版起支援。",
    source: "IBM PC DOS 3.3 Announcement Letter 1987-04-02",
  },
  {
    at: "1987-10-30",
    title: "PC Engine 發售（日）",
    source: "維基百科「PCエンジン」（NEC-HE／ハドソン）",
  },
  {
    at: "1988-01-01",
    title: "報禁解除",
  ...
  {
    at: "1988-10-29",
    title: "Mega Drive 發售（日）",
    source: "維基百科「メガドライブ」（セガ・エンタープライゼス）",
  },
  {
    at: "1988-12-04",
    title: "CD-ROM² 發售（日）",
    note: "PC Engine 的光碟機，家用主機的第一台。",
    source: "維基百科「CD-ROM2」（NEC-HE）",
  },
  {
    at: "1990-11-21",
...
const MAGAZINE: MagazineEventInput[] = [
  ...
  },
  {
    ...
    // 分家本身沒有可查的日子，能查到的是新刊出現的時間，所以錨在試刊號上、
    // 停在月份：寫成「1998」會把標線畫到年初，離實際差了將近一年。
    at: "1998-11",
    title: "自《疾風快報》分家",
    note: "部分疾風人員因經營理念不同出走自創；1998-11-20 發行試刊號，原名《疾風飛訊》，出版者登記為疾風出版有限公司。",
...
export const LANE_GROUPS: string[][] = [
  ...
  // 站上《勝利少年》的已知最後一期是 1997-10-30、尾端不明，《土星少年》最早的
  // 一期是 1998-08-20，兩段在圖上不重疊，會接成同一欄——合併因此讀得出來。
